# Deployed on Fleet IPFS system Lottery App
...
[Example App here!](jolly-grass-0866.on.fleek.co)
[Example App on IPFS here!](https://ipfs.fleek.co/ipfs/QmTJttoEeHRNKvBuBfkkR97QMaVPyaSSgHPTnBqvoUWZ3A/)
...
```
git clone https://github.com/rookasrudzianskas/IPFS-demo
yarn
yarn dev
```
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#github.com/RokasRudzianskas)
